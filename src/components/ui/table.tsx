...
function TableFooter({ className, ...props }: React.ComponentProps<"tfoot">) {
  return (
    <tfoot
      ...
      className={cn(
        "border-t border-divider bg-primary-soft/50 font-medium [&>tr]:last:border-b-0",
        className
      )}
      {...props}
    />
  ...
  return (
    <tr
      ...
      className={cn(
        ...
        transition.colors,
        "hover:bg-surface-hover data-[state=selected]:bg-primary-soft/40",
        className
      )}
      {...props}
    />
...
function TableCell({ className, ...props }: React.ComponentProps<"td">) {
  return (
    <td
      ...
      className={cn(
        "text-body px-4 py-3 align-middle whitespace-nowrap",
        "[&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
        className
      )}
      {...props}
